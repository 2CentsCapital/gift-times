...
language sql stable
as $$
  -- Normalise the query the same way as the target: lowercase, strip every
  -- non-alphanumeric char. So "stock holding", "StockHolding" and "stock-holding"
  -- all match the same records.
